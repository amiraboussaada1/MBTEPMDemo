...
create sequence "MbtEpmDemoService_BusinessPartnerFilterSet_1_0_id_seq" start with 1 increment by 1 nocache;

create table "MbtEpmDemoService_BusinessPartnerFilterSet_1_0"
(
    "client_id" bigint not null,
    "CountryFilter" varchar(12) null,
    "FilterID" bigint not null,
    "is_deleted" tinyint not null,
    "last_modified" timestamp not null,
    primary key ("client_id", "FilterID")
);

create index "MbtEpmDemoService_BusinessPartnerFilterSet_1_0_last_modified_index" on "MbtEpmDemoService_BusinessPartnerFilterSet_1_0" ("last_modified", "is_deleted");
...
create sequence "MbtEpmDemoService_ClientRegistrationSet_1_0_id_seq" start with 1 increment by 1 nocache;

create table "MbtEpmDemoService_ClientRegistrationSet_1_0"
(
    "AuthorizedUser" varchar(800) null,
...
create unique index "MbtEpmDemoService_ClientRegistrationSet_1_0_guid_index" on "MbtEpmDemoService_ClientRegistrationSet_1_0" ("ClientGUID");

create index "MbtEpmDemoService_ClientRegistrationSet_1_0_last_modified_index" on "MbtEpmDemoService_ClientRegistrationSet_1_0" ("last_modified", "is_deleted");
