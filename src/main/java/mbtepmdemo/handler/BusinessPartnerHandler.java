...
public class BusinessPartnerHandler extends com.sap.cloud.server.odata.http.HttpEntityHandler {
    ...
    private final EntityType ENTITY_TYPE = mbtepmdemo.proxy.ComSapMbtepmdemoServiceMetadata.document.getEntityType("mbtepmdemo.BusinessPartner");
    ...
    public BusinessPartnerHandler(mbtepmdemo.MainServlet servlet, mbtepmdemo.proxy.ComSapMbtepmdemoService service) {
    ...
    @Override public DataValue loadAll(DataQuery query) {
        ...
        mbtepmdemo.proxy.BusinessPartner entity = new mbtepmdemo.proxy.BusinessPartner();
        ...
        try {
            ...
            for (int index3 = 0; index3 < count3; index3++) {
                ...
                result.add(entity);
                entity = new mbtepmdemo.proxy.BusinessPartner();
            }
            ok = true;
        }
        finally {
