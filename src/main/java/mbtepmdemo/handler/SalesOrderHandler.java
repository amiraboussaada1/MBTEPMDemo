...
public class SalesOrderHandler extends com.sap.cloud.server.odata.http.HttpEntityHandler {
    ...
    private final EntityType ENTITY_TYPE = mbtepmdemo.proxy.ComSapMbtepmdemoServiceMetadata.document.getEntityType("mbtepmdemo.SalesOrder");
    ...
    public SalesOrderHandler(mbtepmdemo.MainServlet servlet, mbtepmdemo.proxy.ComSapMbtepmdemoService service) {
    ...
    @Override public DataValue loadAll(DataQuery query) {
        ...
        mbtepmdemo.proxy.SalesOrder entity = new mbtepmdemo.proxy.SalesOrder();
        ...
        try {
            ...
            mbtepmdemo.HeaderProvider.getInstance().addHttpHeaders(getDestination(), request);
            ...
            for (int index3 = 0; index3 < count3; index3++) {
                ...
                result.add(entity);
                entity = new mbtepmdemo.proxy.SalesOrder();
            }
            ok = true;
        }
        finally {
    ...
    @Override public void createEntity(EntityValue entityValue) {
        mbtepmdemo.proxy.SalesOrder entity = (mbtepmdemo.proxy.SalesOrder)entityValue;
