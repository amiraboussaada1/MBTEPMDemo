...
public class BusinessPartnerFilterListener extends com.sap.cloud.server.odata.DefaultEntityListener {
    private mbtepmdemo.MainServlet servlet;
    private mbtepmdemo.proxy.ComSapMbtepmdemoService service;

    public BusinessPartnerFilterListener(mbtepmdemo.MainServlet servlet, mbtepmdemo.proxy.ComSapMbtepmdemoService service) {
        super();
